<?php
  ...
  if (isset($_COOKIE['user_name'])) {
    ...
    header("location: home.php?message=Error:+Your+password+was+not+changed.+Cookies+must+be+enabled.");
    exit();
  }
  ...
  if (strlen($new_password) < 6) {
    ...
    header("location: home.php?message=Your+password+has+been+changed.+Please+sign+in.");
    exit();