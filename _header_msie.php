...
<nav class="navbar navbar-default" style="width:1188px;left:-8px">
    <ul class="nav nav-pills" style="background-color:#C0C0F0">
      ...
      Unsubscribe</a></li>
      <li role="presentation" class="btn btn-info" style="width:100px"><a href="help.php" target="_blank">Help</a></li>      
      ...
      <li role="presentation" class="btn btn-info" style="width:123px">
