...
<nav class="navbar navbar-default" style="width:1207px">
    <ul class="nav nav-pills" style="background-color:#C0C0F0">
      ...
      <li role="presentation" class="btn btn-info" style="width:90px"><a href="{$self_name}" onclick="about();">About</a></li>
      ...
      Unsubscribe</a></li>
      <li role="presentation" class="btn btn-info" style="width:102px"><a href="help.php" target="_blank">Help</a></li>      
      ...
      <a href="home.php?view_user_name={$user_name}" target="_blank">Public Page</a></li>
    </ul>
</nav>
EOD;
?>