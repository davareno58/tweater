...
<form action="register.php?return=_chrome" method="POST" autocomplete="off">
<span>
<div>
...
// Display Tweats as Chat in iframe
    $name = strtr($name, " ", "+");
    echo "<iframe id='tweats_iframe' src='get_tweats.php?name={$name}&return=_chrome' style='width:1250px;height:590px;position:absolute;" . 
